...
import com.kyanite.article.repository.TypeRepository;
import com.kyanite.article.service.TypeService;
...
/**
 * REST controller for managing {@link com.kyanite.article.domain.Type}.
 */
@RestController
@RequestMapping("/api")
public class TypeResource {
    ...
    public ResponseEntity<Type> partialUpdateType(@PathVariable(value = "id", required = false) final Long id, @RequestBody Type type)
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, type.getId().toString())
        );
    }
