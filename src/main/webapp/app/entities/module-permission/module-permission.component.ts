...
export default class ModulePermission extends Vue {
  ...
  public mounted(): void {
    this.retrieveAllModulePermissions();
  }
  ...
  public retrieveAllModulePermissions(): void {
  ...
  public prepareRemove(instance: IModulePermission): void {
  ...
  public removeModulePermission(): void {
    this.modulePermissionService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('articleApp.modulePermission.deleted', { param: this.removeId });
