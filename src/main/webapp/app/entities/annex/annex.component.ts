...
export default class Annex extends Vue {
  ...
  public prepareRemove(instance: IAnnex): void {
  ...
  public removeAnnex(): void {
    this.annexService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('articleApp.annex.deleted', { param: this.removeId });
